...
const Home = () => {
  ...
  return (
    <div className="">
      <PageTitle title={`Hello ${user.firstName}, welcome to SUGAR JAR`} />
      <div className="bg-secondary p-2 mt-2 w-50 flex flex-col gap-1">
      ...
      <div className="card p-2 mt-2 w-50 flex flex-col gap-1">
        <div className="flex justify-between">
